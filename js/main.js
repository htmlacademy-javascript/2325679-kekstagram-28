...
import {renderMiniatures, showBlockFilters, setDefaultFilter, setRandomFilter, setDiscussedFilter, sortComments} from './miniature.js';
...
getData()
  .then((images) => {
    ...
    setDiscussedFilter(() => debouncedFunc(images.slice().sort(sortComments)));
  })
  .catch(
    (err) => {
